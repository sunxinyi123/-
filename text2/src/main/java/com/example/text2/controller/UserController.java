...
public class UserController {
    ...
    public  GeneralResponse add(@RequestParam String name, @RequestParam int password, @RequestParam String classNo, @RequestParam String sex, @RequestParam String image) {
        User user = new User();
        user.setName(name);
    ...
    public  GeneralResponse update(@RequestParam String name, @RequestParam int password, @RequestParam String classNo, @RequestParam String sex,@RequestParam int id,@RequestParam String image) {
        User user = new User();
        user.setId(id);
        user.setName(name);
        user.setPassword(password);
